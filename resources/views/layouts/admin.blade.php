...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="/public#" class="nav-link">Contact</a>
            </li>
        </ul>
        ...
        <ul class="navbar-nav ml-auto">
            <!-- Navbar Search -->
            <li class="nav-item">
                <a class="nav-link" data-widget="navbar-search" href="/public#" role="button">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" data-toggle="dropdown" href="/public#">
                    <i class="far fa-comments"></i>
                    <span class="badge badge-danger navbar-badge">3</span>
                </a>
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <a href="/public#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="/public#" class="dropdown-item dropdown-footer">See All Messages</a>
                </div>
            </li>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="/public#" class="dropdown-item dropdown-footer">See All Notifications</a>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-widget="fullscreen" href="/public#" role="button">
                    <i class="fas fa-expand-arrows-alt"></i>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-widget="control-sidebar" data-controlsidebar-slide="true" href="/public#" role="button">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="/public#" class="d-block">Alexander Pierce</a>
                </div>
            </div>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2014-2021 <a href="/public/https://adminlte.io">AdminLTE.io</a>.</strong>
        All rights reserved.
